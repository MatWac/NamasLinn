...
public class MoultingMachineScreen extends AbstractContainerScreen<MoultingMachineMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(NemasLinn.MODID, "textures/gui/moulting_machine.png");
    private FluidTankRenderer renderer;

    public MoultingMachineScreen(MoultingMachineMenu menu, Inventory inventory, Component component) {
    ...
    private void renderFluidAreaTooltips(PoseStack pPoseStack, int pMouseX, int pMouseY, int x, int y) {
        if(isMouseAboveArea(pMouseX, pMouseY, x, y, 56, 15)) {
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        renderer.render(pPoseStack, x+56, y+15, menu.getFluidStack());
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y) {
        if(menu.isProgress()) {
            ...
            blit(pPoseStack, x + 108, y + 53, 176, 0, p+1 , 16);
        }
    }
